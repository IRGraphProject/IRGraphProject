...
#  crop wikipedia articles to the same length, write to files
...
# files
file_en = codecs.open("../data/wiki_english.txt","w","utf-8") # english
file_sim = codecs.open("../data/wiki_simple.txt","w","utf-8") # simple english
file_titles = codecs.open("../data/wiki_titles.txt","w","utf-8") # debug
...
def main():
	for row in wiki.find():
		...
		# write remaining sentences to file
