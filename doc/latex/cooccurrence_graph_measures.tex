...
\paragraph{Python}
Nach sprachunanbängigen Recherchen über verwendbare Bibliotheken haben wir uns wegen der bereits implementierten Graphalgorithmen in \texttt{graph-tool}\footnote{\url{http://graph-tool.skewed.de/}} für die Programmiersprache Python\footnote{\url{https://www.python.org/}} entschieden. Wegen der Unicodeunterstützung wurde Python 3 gewählt.

\paragraph{Natural Language Toolkit}
Das NLTK\footnote{\url{http://www.nltk.org/}} ist ein Framework f\"ur Sprachverarbeitung in Python. Die verwendete Stopwortlisten, sowohl für Deutsch, als auch für Englisch stammen aus der Bibliothek.
...
\cite{Hu2005} gelayoutet, Histogrammdaten wurden aus aus graph\_tool nach R
