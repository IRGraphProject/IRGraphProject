...
\begin{table}
    ...
    \label{tab-zsf}
\end{table}
% TODO: nach dem Endlayout sicherstellen, dass diese Fußnote an der richtigen
% Stelle auftaucht
\footnotetext[6]{größte Zusammenhangkomponente}
...
\begin{thebibliography}{9}
    ...
    \bibitem{Hu2005} Y. Hu, “Efficient, High-Quality Force-Directed Graph Drawing,” \emph{The Mathematica Journal}, vol. 10, no. 1, pp. 37–71, 2006.
