...
Korpusgraphen mittels eines \texttt{force-directed graph} nach
...
erf\"ullt ist. Dabei ist zwar zu beachten, dass die leichten Sätze deutlich kürzer sind, jedoch sind die Unterschiede recht deutlich, insbesondere bei den englischen Corpora, trotz Abdeckung gleicher Themengebiete. 
...
dem Zipfschen Gesetz. Die für diese Verteilung typische Gerade ist auf den logarithmierten Graphen deutlich erkennbar.
...
auftretende Querverbindungen) einbezogen werden, bei 2 kommen 2 zusätzlich deren
Nachbarn hinzu, sodass alle Knoten, die innerhalb des angegebenen Abstandes vom
Ausgangsknoten liegen verwendet werden.
