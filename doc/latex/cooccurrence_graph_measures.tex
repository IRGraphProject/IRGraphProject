...
Der denews-Corpus hat 3205 Knoten, wovon 3142 auf die größte
...
Der nl-Corpus weist mit $15,1\cdot 10^{-4}$ eine fast doppelt so
...
In Tabelle \ref{tab-zsf} sind die Ergebnisse der vorgestellten Maße aufgelistet, darunter die Clusteringkoeffizienten der Graphen.
...
Der Quotient aus $C/C_{rand}$ ist in allen Fällen unter $1$, für den nl-Graphen liegt er bei $0,96$.
Der ursprüngliche Graph und sein zufällig verändertes Pendant haben also beinahe denselben Clusteringkoeffizienten.
Zusammengefasst ist deutlich erkennbar, dass die Clusteringkoeffizienten nicht in Wertebereichen liegen, die für Small-World-Eigenschaften notwendig wären.
...
So sind etwa \emph{Seymour} und \emph{Hoffman} im nl-Corpus lediglich ein mal vorgekommen, im Zuge der Todesnachricht des Schauspielers.
Des öfteren ist zu beobachten, dass insbesondere fremdsprachige Eigennamen die Graphgrenzen ausmachen:
So liegen im englischsprachigen wiki\_sim-Corpus \emph{Che Guevara}, \emph{Kamui Kobayashi}, \emph{Kazimir Malevich} und die \emph{Frankfurter Allgemeine Zeitung} ganz aussen.

Beim denews10k-Graphen sind \emph{Microsoft}, \emph{Windows}, und \emph{Phone} in Zusammenhang aussen, oder auch \emph{Financial} und \emph{Times}, jedoch auch \emph{Christoph Metzelder} und \emph{St. Pauli}.
...
Wie die Ergebnisse der Clusteringkoeffizienten bereits andeuten, lässt sich mit dem verwendeten Maß leider nicht nachweisen, dass es sich bei den Kookkurrenzgraphen um Small-World-Graphen handelt.
...
Bei denews10k liegt er -- bedingt durch die geringe Dichte -- sogar unter $0,5$.
